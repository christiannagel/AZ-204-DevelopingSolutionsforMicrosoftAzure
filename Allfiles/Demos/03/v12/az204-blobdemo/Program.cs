...
async Task<(string, string)> UploadBlobAsync(BlobContainerClient containerClient)
{
...
async Task<string> DownloadBlobAsync(string itemName, string sourceFile, BlobContainerClient blobContainerClient)
{
...
async Task DeleteContainerAsync(BlobContainerClient blobContainerClient, string sourceFile, string destinationFile)
{
